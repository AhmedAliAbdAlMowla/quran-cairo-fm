...
function setupEventListeners() {
    ...
    egyptAudio.addEventListener('loadstart', () => {
        ...
        counterLabel.textContent = 'جاري التحميل...';
    ...
    egyptAudio.addEventListener('error', () => {
        statusText.textContent = 'خطأ في تحميل البث';
        playerPanel.classList.remove('playing');
        counterLabel.textContent = 'خطأ';
...
if (isIOS) {
    ...
    // Add iOS notice
    if (volumeValue) {
        volumeValue.title = 'استخدم أزرار الصوت في الجهاز';
    }
} else {
...
egyptAudio.addEventListener('play', () => {
    ...
    counterLabel.textContent = 'يتم التشغيل الآن';
});
...
egyptAudio.addEventListener('pause', () => {
    ...
    stopCounter();
    liveIndicator.classList.remove('active');
    counterLabel.textContent = 'متوقف مؤقتاً';
});
...
egyptAudio.addEventListener('ended', () => {
    ...
    stopCounter();
    liveIndicator.classList.remove('active');
    counterLabel.textContent = 'متوقف';
});
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Add touch feedback to all control buttons
